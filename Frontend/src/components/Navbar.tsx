      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Comparte tus proyectos increíbles con la comunidad.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {/* 🧩 NUEVO BOTÓN: Ir a gestión de perfil */}
            <Link
              to="/profile"
              className="flex items-center gap-2 px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-lg transition-all duration-200 font-medium"
            >
